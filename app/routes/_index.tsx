...
function Page() {
    return (
        <div className="bg-center bg-cover " style={{
            ...
            <div className="pt-16 relative min-h-screen flex items-center justify-items-start overflow-auto backdrop-blur-sm">
                <div className="pl-4">
                    {/* 外层正方形 */}
                    <div
                        className="absolute w-64 h-64 border-4 border-gray-300 transform scale-550 rotate-16 left-1/6 top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
                    <div
                        className="absolute w-56 h-56 border-4 border-gray-300 transform scale-450 rotate-28 left-1/6 top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
                    <div
                        className="absolute w-48 h-48 border-4 border-gray-300 transform scale-350 rotate-40 left-1/6 top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
                    <div
                        className="absolute w-40 h-40 border-4 border-gray-300 transform scale-250 rotate-52 left-1/6 top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
                    <h1 className="font-blophy font-bold bg-gradient-to-r from-blue-500 to-green-500 text-transparent bg-clip-text text-7xl relative -top-6 left-2/3">
                        blophy nova
                    </h1>
                </div>
                <h2 className="absolute top-40 left-126/240 text-4xl font-bold">关注我们</h2>
                <div className="absolute top-55 left-13/24 flex items-center">
                ...
                <h2 className="absolute top-70 left-126/240 text-4xl font-bold">下载</h2>
                <div className="absolute top-85 left-13/24 items-center">
                    <div className="flex">
                        <Link
                            to="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=ZC8-lrN0E651rGLKosBzYr-fPtPh9ntQ&authKey=gDfCU%2BeFTcW6cyJyrnrJbzkuM9oTHTRtBMNICjZuBhzGw3j4%2FMlVAqhI3sVGcWQC&noverify=0&group_code=761741595"
                            target="_blank">
                        ...
                        <div className="pt-1 px-1">游戏本体在QQ群中下载</div>
                    </div>
                    <div className="flex pt-2">
                        ...
                        <div className="pt-1.5 px-1">BlophyNova Edit(制谱器)</div>
                    </div>
                    <div className="flex pt-2">
                        ...
                        <div className="pt-1.5 px-1">从Malody导入BPM List和偏移量</div>
                    </div>
                </div>
                <h2 className="absolute top-120 left-126/240 text-4xl font-bold">来看看我们的最新视频！</h2>
                <iframe
                    ...
                    width="400"
                    height="225"
                    className="absolute top-135 left-13/24 border-0"
                    allowFullScreen

        ...
        >
            ...
            >
                <div className="relative flex justify-center items-center pl-8 h-screen">
                    ...
                    <div
                        className="absolute top-[10%] left-[290%] transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
                    ...
                    <div
                        className="absolute top-[32%] left-[290%] transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
                    ...
                    <div
                        className="absolute top-[48%] left-[315%] transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
                        ...
                        <iframe
                            ...
                            width="500"
                            height="281.25"
                            className="absolute pt-4 pl-4 border-0"
                            allowFullScreen
                    ...
                    <div
                        className="absolute top-[86%] left-[295%] transform -translate-x-1/2 -translate-y-1/2 text-center z-10">

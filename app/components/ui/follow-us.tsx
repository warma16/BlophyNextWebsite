    ...
    return <div className={"flex justify-center space-x-4 items-center z-10" + props.className}>
        ...
        <Link
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 448 512"
                 className="ml-2 flex-shrink-0 hover:text-blue-300 max-lg:text-blue-300 max-lg:hidden">
                <path fill="currentColor"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"
                 className="ml-2 flex-shrink-0 hover:text-blue-300 max-lg:text-blue-300 max-lg:block">
                <path fill="currentColor"
